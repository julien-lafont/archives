...
default:
	...
	$c= '<form action="'.$page.'&action=modifier" method="post" class="f-wrap-1" onsubmit="$(\'#FOOTER\').val(oEdit1.getHTMLBody());">
			...
			<label for="KEYWORDS"><b>Metatag Keywords : mots cl&eacute;s</b>
			...
			<label for="PAGE_DEFAUT"><b><span class="req">*</span> Page par d&eacute;faut affich&eacute;e sur l\'accueil du site</b>
				<input id="PAGE_DEFAUT" name="PAGE_DEFAUT" type="text" class="f-name" maxlength="255" style="width:100px" value="'.$config['PAGE_DEFAUT'].'"/> &nbsp;&nbsp;&nbsp;<span class="txt11">Ex : accueil</span><br />
			</label>
			...
			<label for="NB_NEWS"><b><span class="req">*</span> Nombres de news à afficher dans le footer</b>
				<input id="NB_NEWS" name="NB_NEWS" type="text" class="f-name" maxlength="5" value="'.$config['NB_NEWS'].'" style="width:30px" /><br />
			</label>
...
case "modifier":
	...
	foreach($_POST as $cle=>$val) {
		...
		$val=mysql_real_escape_string(utf8_decode($val));
