  ...
  for(var i=0;i<this.buttonMap.length;i++)
    ...
    switch(sButtonName)
      ...
      case "Bookmark":
        ...
        break;
      case "Hyperlink":
        if(this.btnHyperlink)sHTMLIcons+=this.writeIconStandard("btnHyperlink"+this.oName,this.oName+".hide();modelessDialogShow('"+this.scriptPath+"hyperlink.htm',380,200)","btnHyperlink.gif",getTxt("Hyperlink"));
        break;
      case "CustomTag":
      ...
      case "InternalLink":
        ...
        break;
      case "InternalImage":
        if(this.btnInternalImage)sHTMLIcons+=this.writeIconStandard("btnInternalImage"+this.oName,this.oName+".hide();"+this.cmdInternalImage,"btnInternalImage.gif",getTxt("Internal Image"));
        break;
      case "CustomObject":
      ...
      case "HTMLFullSource":
        ...
        break;
      case "HTMLSource":
        if(this.btnHTMLSource)sHTMLIcons+=this.writeIconStandard("btnHTMLSource"+this.oName,"setActiveEditor('"+this.oName+"');"+this.oName+".hide();modalDialogShow('"+this.scriptPath+"source_html.htm',600,450);","btnSource.gif",getTxt("View/Edit Source"));
        break;
      case "XHTMLFullSource":
        ...
        break;
      case "XHTMLSource":
        if(this.btnXHTMLSource)sHTMLIcons+=this.writeIconStandard("btnXHTMLSource"+this.oName,"setActiveEditor('"+this.oName+"');"+this.oName+".hide();modalDialogShow('"+this.scriptPath+"source_xhtml.htm',600,450);","btnSource.gif",getTxt("View/Edit Source"));
        break;
      case "ClearAll":
...
function dropShow(oEl,box)
  ...
  box.style.zIndex = 11;//Set the Z-index higher for the frame
...
function showFrame(box){
  if(isIE){
    var ifrm=document.getElementById("zIndexFrame");
    ...
    width += convertBorderWidth(box.style.borderLeftWidth) + convertBorderWidth(box.style.borderRightWidth);
    height += convertBorderWidth(box.style.borderBottomWidth) + convertBorderWidth(box.style.borderTopWidth);
...
function hideFrame(){
  if(isIE){
    document.getElementById("zIndexFrame").style.display = "none";
  }
}
...
function recur(oEl,sTab)
  ...
  for(var i=0;i<oEl.childNodes.length;i++)
    ...
    if(oNode.nodeType==1)//tag
      ...
      var sCloseTag = oNode.outerHTML.substr(oNode.outerHTML.lastIndexOf("<"));//spy bisa <a:b>
