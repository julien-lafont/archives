...
define('LACE_SITE_NAME', 'Mon-Look.com');

/** A description of your chatroom; appears only as part of the
	  <title> tag. */
define('LACE_SITE_DESCRIPTION', 'Mon-Look : Site de rencontre Francophone !');
...
define('LACE_URL_ABS', 'http://www.yotsumi.info/Mon-Look/chat/');

/** Relative URL to Lace including trailing slash
   (e.g. '/lace/' or simply '/') */
define('LACE_URL_REL', '/Mon-Look/chat/');
