...
<tr>
	<td class="name">
		<input type="text" name="name" id="name" maxlength="10" size="10" readonly="" value="<?php echo $name; ?>" disabled style="background-color:#FFFFFF; border:1px solid #777777; color:#3366FF"/>
	</td>
	<td>
		<input type="text" name="text" id="text" maxlength="<?php echo LACE_MAX_TEXT_LENGTH; ?>" size="50"/>
		<input type="submit" name="say" id="say" value="Chat" class="button" />
	</td>
</tr>
</tbody>
</table>
