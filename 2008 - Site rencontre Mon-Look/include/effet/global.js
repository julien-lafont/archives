...
}(); addEvent(window,'unload',EventCache.flush); function expandTree(treeId) { var ul = document.getElementById(treeId); if (ul == null) { return false;}
expandCollapseList(ul,nodeOpenClass);}
function collapseTree(treeId) { var ul = document.getElementById(treeId); if (ul == null) { return false;}
expandCollapseList(ul,nodeClosedClass);}
function blockEvents(evt) { evt = (evt) ? evt : ((window.event) ? window.event : ""); if(evt.target){ evt.preventDefault();}else{ evt.returnValue = false;}
}
$(document).ready(function(){ $("a.expandAll").click(function(e){expandTree('treemenu1');blockEvents(e);}); $("a.collapseAll").click(function(e){collapseTree('treemenu1');blockEvents(e);}); $("ul.treemenu").find("a").click(function(){$("ul.treemenu").find("a").removeClass("treeMenuFocus");this.className = 'treeMenuFocus'}); $("a.printButton").click(function(e){window.print();blockEvents(e);});}); 