...
<head>
	...
	<title>Studio-dev.fr - Actualité : {::titrePage::}</title>	
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
	<meta name="Description" content="Studio-dev.fr : Développements web 2.0 et design par Julien LAFONT alias YoTsumi - Portfolio, blog et tutoriaux" />
		  ...
		  <div class="story first">
			...
			<div class="details">
				Posté le <span id="n_date">{::news_date::}</span> &rsaquo; <span id="n_cat">{::news_cat::}</span>
					<div id="fleches">
						<a href="#" onclick="news_naviguer('precedente','detail'); return false" id="fleche_gauche"><img src="images/fleche_gauche.gif" alt="Pr&eacute;c&eacute;dente" /></a>
						<a href="#" onclick="news_naviguer('suivante','detail'); return false" id="fleche_droite" style="display:none"><img src="images/fleche_droite.gif" alt="Suivante" /></a>
					</div>
			</div>
		...
		<div class="inside">
			<div class="block first">
				...
				<p>Pour me contacter, rendez vous sur <a href="contact.htm" title="Contacter Julien LAFONT : développeur web 2.0">cette page</a> ou sinon envoyez un petit mail à <br /> <img src="images/email_black.png" class="noborder"/></p>
		  		<p class="img_no_border" style="margin:10px 0 0 10px"><img src="images/doc.png" style="vertical-align:middle; border:0" /> &nbsp;<a href="cv-julien-lafont.htm" title="Voir le CV de Julien Lafont alias Yotsumi" style="border-bottom:1px solid #f06; text-decoration:none">Afficher mon CV</a></p>
			</div>
