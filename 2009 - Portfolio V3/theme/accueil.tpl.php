...
<head>
	...
	<meta name="Description" content="Développement web 2.0 et Design par Julien Lafont alias YoTsumi @ Studio-dev.fr - Compétences clés : Internet 2.0, Référencement, E-Commerce, Blogs, Sécurité, Podcast, Design " />
	<meta name="Keywords" content="studio-web, studio, yotsumi, julien, lafont, orange, montpellier, développeur, ajax,  php, web, création, site, portfolio, blog, services, designer, graphiste, programmeur, freelance, jquery, prototype, mvc, sql, php5, référencement, intégration, xhtml, ada, windev, IUT, montpellier, chansons-paroles, fais ton choix, pleax" />
	<meta name="author" content="Julien LAFONT alias YoTsumi @ freelance_at_studio-dev_point_fr">
...
<body>
	...
	<div id="primary" class="twocol-stories" style="background-image:url({::urlTheme::});">
	
		<div id="wait"><img src="images/wait.gif" alt="wait" /></div>
		
		<div class="inside" id="primary_effect">
		  
		  <div class="story first">
			<h3 id="n_titre">{::news_titre::}</h3>
			<div class="details">
				Posté le <span id="n_date">{::news_date::}</span> &rsaquo; <span id="n_cat">{::news_cat::}</span>
					<div id="fleches">
						<a href="#" onclick="news_naviguer('precedente', 'apercu'); return false" id="fleche_gauche"><img src="images/fleche_gauche.gif" alt="Précédente"/></a>
						<a href="#" onclick="news_naviguer('suivante', 'apercu'); return false" id="fleche_droite" style="display:none"><img src="images/fleche_droite.gif" alt="Suivante" /></a>
					</div>
			</div>
			
			<div id="n_contenu">{::news_contenu::}</div>
