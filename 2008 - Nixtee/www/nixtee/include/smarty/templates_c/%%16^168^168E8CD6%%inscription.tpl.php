<?php /* Smarty version 2.6.18, created on 2008-04-15 21:30:41
...
<div class="bloc">
	...
	<div class="erreur" style="display:<?php if (isset ( $this->_tpl_vars['erreur'] )): ?> block <?php else: ?> none <?php endif; ?>">
		<h3 style='font-size:14px'>Une erreur est survenue  durant la validation de votre inscription : </h3><br />
