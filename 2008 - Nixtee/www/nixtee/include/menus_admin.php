...
$mm = '
	<ul id="nav">
		...
		$mm.='<li'; if (strpos($page, 'billets')!==false) $mm.=' class="active"'; $mm.='><a href="#" onclick="return false">Billets</a>
				<ul>
				...
				<li class="last'; if ($page=="billets-categories") $mm.=' active'; $mm.='"><a href="admin.php?billets-categories">Cat&eacute;gories</a></li>
				</ul>
			</li>';
	
		$mm.='<li'; if (strpos($page, 'commentaires')!==false) $mm.=' class="active"'; $mm.='><a href="#" onclick="return false">Commentaires</a>
				<ul>
				<li class="first'; if ($page=="commentaires-gerer") $mm.=' active'; $mm.='"><a href="admin.php?commentaires-gerer">Gerer</a></li>
				<li class="last'; if ($page=="commentaires-amoderer") $mm.=' active'; $mm.='"><a href="admin.php?commentaires-amoderer">A mod&eacute;rer</a></li>
				</ul>
			</li>';
		...
		$mm.='<li'; if (strpos($page, 'membres')!==false) $mm.=' class="active"'; $mm.='><a href="#" onclick="return false">Membres</a>
				...
				<li class="last'; if ($page=="membres-admins") $mm.=' active'; $mm.='"><a href="admin.php?membres-admins">Admins & modos</a></li>			
				</ul>
			</li>';
