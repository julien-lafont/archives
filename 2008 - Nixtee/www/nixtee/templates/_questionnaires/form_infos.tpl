		...
		<fieldset>
			...
			<table style="width:85%;">
				<tr>
					...
					<td style="width:45%"><h3 style="width:85%"><a href="#" title="Etape 3/3 : Personnaliser mon questionnaire" onclick="$('#form_info').attr('action', 'questionnaires-personnaliser-{$form.id_form_type}.htm').submit(); return false">Personnaliser le questionnaire</a></h3></td>
					<td>				  <h3 style="width:85%"><a href="#" title="Enregistrer le questionnaire" onclick="$('#form_info').attr('action', 'questionnaires-enregistrer-{$form.id_form_type}.htm').submit(); return false">Questionnaire terminé</a></h3></td>
				</tr>
				<tr>
					<td></td>
				...
				<tr>
					<td></td>
					<td><div class="bouton" style="margin-left:25px"><a href="#" title="Etape 3/3 : Personnaliser mon questionnaire" onclick="$('#form_info').attr('action', 'questionnaires-personnaliser-{$form.id_form_type}.htm').submit(); return false">Etape 3/3 : Personnalisation</a></div></td>
					<td><div class="bouton" style="margin-left:15px"><a href="#" title="Enregistrer le questionnaire" onclick="$('#form_info').attr('action', 'questionnaires-enregistrer-{$form.id_form_type}.htm').submit(); return false">Enregistrer le questionnaire</a></div></td>		
				</tr>
			</table>
			<br class="clear" />
