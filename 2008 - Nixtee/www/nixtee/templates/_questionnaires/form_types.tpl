...
<div class="bloc">
	...
	{foreach item=form from=$apercus}
		<li><h2>{$form.nom}</h2>
			...
			<div class="apercu" id="apercu_{$form.id_form_type}" style="display:none">
				{$form.html}
			</div>
		    ...
		    <div class="bouton"><a href="questionnaires-infos-{$form.id_form_type}.htm" title="">Choisir ce questionnaire</a></div>
		    <br class="clear" />
