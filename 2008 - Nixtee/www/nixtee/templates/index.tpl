...
<div id="page">
	...
	<div id="bandeau">
        ...
        <div class="right">
        	<ul>
            	<li class="inscrip ">
                	<div class="image {if $est_connecte}barre{/if}"><a href="inscription.htm" title="Inscrivez-vous sur Nixtee pour commencer à personnaliser vos questionnaires."><img src="images/pix.gif" width="45" height="45" alt="" /></a></div>
                    <div class="texte {if $est_connecte}barre{/if}">
