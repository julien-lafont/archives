...
default:
	...
	$contenu='<div id="retour"><a href="?admin-accueil">&lsaquo; Retour &lsaquo;</a></div>
			  
			  <br><br><div id="infoInscription">
				Utilisez cette page pour gérer la galerie de la team D4
			  </div>
	...
	else
	{
		while($data = mysql_fetch_object($sql)) {
			...
			$contenu.= "<tr>
							...
							<td class='liste_txt'>
								<center><a href='images/upload/galerieD4/".$data->photo."'><img src='images/upload/galerieD4/min_".$data->photo."' class='imgAvatar' width='70' height='60' id='img".$data->id."' alt='".nl2br(recupBdd($data->description))."' onmouseover='montre(this.id)' onmouseout='cache();' /></a></center>
							</td>
							<td class='liste_txt'>
								<a href='?admin-galerie&action=editPhoto&id=".$data->id."'>Editer</a><br />
								<a href='?admin-galerie&action=supprPhoto&id=".$data->id."'>Supprimer</a>
...
case "upload":
	...
	$contenu='
		<div id="retour"><a href="?admin-galerie">&lsaquo; Retour &lsaquo;</a></div>
...
case "upload2":
	...
	$chemin="images/upload/galerieD4/";
	if (!is_dir($chemin)) { mkdir($chemin,0777); }
	@chmod($chemin, 0777);

	$cheminTemp = "images/upload/galerieD4/temp/"; 
...
case "editPhoto":
	...
	$contenu='	
		...
		<br><form id="form" action="?admin-galerie&action=editPhoto2" method="post" enctype="multipart/form-data" >
			<center><br />
				<b style="border-bottom:1px solid #FF9900">Editer les infos d\'une photo</b><br /><br /><br />
			<br /><b><span style="color:#00A8FF">É</span>TAPE 2 : <span style="border-bottom:1px solid #FF9900">Indiquez une description</span></b> (facultatif)<br /><br />
...
case "gererCat":
	...
	while ($d=mysql_fetch_object($sql)) {
	  ...
	  $contenu='<div id="retour"><a href="?admin-galerie">&lsaquo; Retour &lsaquo;</a></div>
	  			
				<br><center><div id="posterNews"><a href="?admin-galerie&action=ajCat">Ajouter une catégorie</a></div></center>
				<br /><div id="team"><div class="cadreLien"><a class="lienTeam">&raquo; Liste des catégories de la Galerie</a></div></div><br />';
		...
		else
		{
			...
			{
				if (empty($cat->img)) { $min="default/no_min1b.jpg"; $imgDefault="<i>Miniature par défault</i><br />"; }
				else				  { $min=$cat->img; $imgDefault=""; }
				
				$contenu.='
						<table style="border:0; width:90%; border-bottom:1px solid #ccc; margin-bottom:7px" align="center">
						  <tr>
							<td style="width:210px; text-align:center"> '.$imgDefault.'<img src="images/upload/galerieD4/'.$min.'" class="imgGalerie" /></td>
							<td style="text-align:center">
								...
								<a href="#" onclick="$(\'supprCat'.$cat->id.'\').style.display=\'block\'; return false;">Supprimer catégorie</a>
...
case "ajCat":
	...
	$contenu='<div id="retour"><a href="?admin-galerie&action=gererCat">&lsaquo; Retour &lsaquo;</a></div>
...
case "changerMinCat":
	...
	$contenu='<center><b>Changer le miniature de cette catégorie</b>
		<br \><br \><b>Image actuelle</b><br />
		<img src="images/upload/galerieD4/'.$min.'"class="imgGalerie" /><br /><br />
		  ...
		  <tr>
		  	<td style="text-align:center">
				...
				<select class="formnews2" id="selectImg" onChange="showimage()">
						...
						<option value="default/no_min1b.jpg">Image par défaut</option><br>
						<option value="default/error.jpg"> </option>';
		
				$dossier = opendir ("images/upload/galerieD4/");
				...
				$contenu .= '</select><br /><br /><div style="font-size:10px">Les images sont situés dans <b>images/upload/galerieD4/</b><br /><br />
											   Leur nom doit commencer par "_min" et finir par .jpg, .png, .gif</div>
				
			</td>
		    <td>
			 	<img src="images/upload/galerieD4/default/no_min1b.jpg" id="imgCible" width="200" height="160" alt="Miniature" align="absmiddle" class="imgGalerie" />
			</td>
		   </tr>
		   <tr>
...
case "supprCat";
	...
	if ($transfert=="suppr") {
		...
		while ($d1=mysql_fetch_object($sql1))
		{
			...
			@unlink('images/upload/galerieD4/'.$d1->img);
			@unlink('images/upload/galerieD4/min_'.$d1->img);
		}
