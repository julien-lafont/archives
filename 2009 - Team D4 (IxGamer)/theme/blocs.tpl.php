...
<head>
	...
	<script type="text/javascript" src="include/js/scriptaculous.js?load=effects,controls"></script>
	<script type="text/javascript" src="include/js/niftycube.js"></script>
	<script type="text/javascript" src="include/js/windows/window.js"></script>
				...
				<td><div id="bloc_left">
					...
					<div id="bloc_cadreC">
						...
						<table id="tableau_deux_blocs" cellpadding="0" cellspacing="0">
							<tr>
								<td class="tdLatteralGauche">

									<table id="inLatteralG" cellpadding="0" cellspacing="0">
										<tr>
