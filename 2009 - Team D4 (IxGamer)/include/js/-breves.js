...
function adEdit(id) {
	...
	edit = new Window('showEdit', {className: "alphacube", title: "Mes commentaires", url: _URL+"pages/breves_ajax.php?act=com_edit&id="+id, width:335, height:200, maximizable:true, minimizable:true, resizable: true, showEffectOptions: {duration:1}});
	edit.showCenter();
}