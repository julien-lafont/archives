...
function modalDialogShow(url,width,height)//moz
    ...
    activeModalWin = window.open(url, "", "width="+width2+"px,height="+height+",left="+left+",top="+top);
...
function selectFile(index)
	{
	sFile_RelativePath = "http://aneixisa.network-hosting.com/rosberteweb/images"+document.getElementById("inpFile"+index).value;
...
<td class="dialogFooter" style="height:40px;padding-right:15px;" align=right valign=middle>
	...
	<tr>
	<td>
	<input name="btnOk" id="btnOk" type="button" value=" > > > ok < < <" onClick="doOk()" class="inpBtn" style="background-color:#0099FF; color:#FFFFFF" onMouseOver="this.className='inpBtnOver';" onMouseOut="this.className='inpBtnOut'">
	</td>
	</tr>
	</table>
</td>
