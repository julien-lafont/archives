...
/**
 * ArticleIndex form base class.
 *
 * @method ArticleIndex getObject() Returns the current form's model object
 *
 * @package    foliov4
 * @subpackage form
 ...
 */
abstract class BaseArticleIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('article_index[%s]');
