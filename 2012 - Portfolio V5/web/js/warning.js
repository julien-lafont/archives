var msg1 = "Attention : Saviez-vous que votre version d'Internet Explorer est périmée ?";
var msg2 = "J'ai à coeur que mon site internet me ressemble, et étant attirée par les dernières technologies, mon site est lui aussi développé en utilisant des technologies modernes. Malheureusement, votre navigateur vieux de 8 ans d'âge n'est pas compatible, je ne saurais que vous conseiller de le mettre à jour !";
var msg3 = "Il suffit de cliquer sur l'icone du navigateur correspondant pour se rendre à sa page de téléchargement.";
var msg4 = "Cliquez à l'extérieur du cadre pour fermer cette alerte... et rendez-vous dans les années 90 !";
var br1 = "Internet Explorer 8+";
var br2 = "Firefox 3+";
var br5 = "Safari 4+";
var br4 = "Opera 10+";
var br3 = "Chrome 5.0+";
var url1 = "http://www.microsoft.com/france/windows/internet-explorer/telecharger-ie8.aspx";
var url2 = "http://www.mozilla.com/firefox/";
var url5 = "http://www.apple.com/fr/safari/";
...
_dl.style.top = "0px";
_dl.style.left = "0px";
_dl.style.filter = "alpha(opacity=90)";
_dl.style.background = "#000";
_dl.style.zIndex = 99999;
_dl.onclick=function() {
...
_dd.style.padding = "20px 20px 10px 20px";
...
_p1d.style.color = "#333333";

_p2.appendChild(document.createTextNode(msg3));
var _p2d = document.getElementById('_p2');
_p2d.style.marginBottom = "1em";
_p2d.style.color = "#333333";

_p3.appendChild(document.createTextNode(msg4));
var _p3d = document.getElementById('_p3');
_p3d.style.textAlign = "right";
_p3d.style.color = "#333333";
...
_ico3ds.background = "transparent url('"+imgPath+"browser_chrome.gif') no-repeat scroll left top";
_ico4ds.background = "transparent url('"+imgPath+"browser_opera.gif') no-repeat scroll left top";
_ico5ds.background = "transparent url('"+imgPath+"browser_safari.gif') no-repeat scroll left top";
