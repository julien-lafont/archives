<?php
/**
 * Appel Ajax - Page Brèves
 * Nécessaire à certaines actions du module Brèves
 *
 */
...
break;
#####################################################################################################"""
// Editer un commentaire ( admin ou membre )
case "com_edit":
	...
	$d=mysql_fetch_object($sql);
		...
		<body>	
			...
			<br />
			<form id="form" method="post" action="<?php echo URL; ?>pages/breves_ajax.php?act=com_edit2">
