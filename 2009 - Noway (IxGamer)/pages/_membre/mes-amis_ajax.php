...
case "infos":
	...
	echo $id.SEPARATOR;
	echo '	<div class="image"><img src="pages/fonctions/redim.php?imgfile='.URL.'images/upload/avatar/'.$avatar.'&max_width=114&max_height=130" id="img'.$id.'" /></div>
			<div style="float:right;"><a href="#" onclick="supprAmi('.$id.'); return false;"><img src="images/boutons/agt_stop.png" id="supprAmi'.$id.'" onmouseover="tooltip.show(this, \'<u>Mes amis</u><br /><br /><p>Supprimer <b>'.$d->pseudo.'</b> de ma liste d\\\'amis</p>\');" onmouseout="tooltip.hide(this)"/></a></div>
			<div class="infos">
