...
$design->zone('header', '<script type="text/javascript" src="javascript/-amis.js"></script>');
...
default:
	...
	$contenu='<div class="titreMessagerie">My Friends</div>
...
case "accepterAll":
	...
	$futur=mysql_fetch_object($sqlFutur);
		...
		if (!empty($futur->amis)) $tabloFF=explode('-', $futur->amis);
		else $tabloFF=array();
