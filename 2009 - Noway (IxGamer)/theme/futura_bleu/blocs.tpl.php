...
<head>
	...
	<title>warriors of Legend - {::titrePage::}</title>	
    ...
    <div id="corps">
    	...
    	<div id="centre">
            ...
            <div id="chargement" style="display:none">
                <span id="in_chargement" ><img src="images/loader_blue.gif" /><div id="in_chargement_txt"></div></span>
            </div>
                    
			<div class="content">
            	
                {--bloc--}
            	<h2 class="barre">{:titre:}</h2>
				<p class="in" style="margin-bottom:15px; font-size:11px">{:contenu:}</p>
                {--/bloc/--}
