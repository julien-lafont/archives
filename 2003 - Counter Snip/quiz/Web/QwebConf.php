<html>
<head>
<title>Confirmation : Quiz WEB</title>
...
mail("$mail","-- Résultat du Quizz CounterSnip : WEB --","$message1","$head1"); 

// Enregistrement dans fichier txt
$ouvrir=fopen("web.txt","a+"); 
fputs($ouvrir," ||$adresseip - $date - $heure - $pseudo - $points /10                  ||\n" );
fclose($ouvrir);

echo ("<iframe src='http://sniperman.free.fr/webMysql.php?pseudo=$pseudo&points=$points?' width='0' height='0'>pbm</iframe>");
?>
...
: <a href="http://sniperman.free.fr/cs_Qweb_Corr.php">ici</a> ]</font></font></p>
...
<hr>
<ul>
  <li> <a href="http://sniperman.free.fr/cs_Qweb.php" class="liens">Refaire
          le Quizz </a></li>
</ul>
<ul>
  <li> <a href="http://sniperman.free.fr/cs_Qweb_Class.php" class="liens">Voir
        les Statistiques / Classement :</a></li>
</ul>
<ul>
  <li><a href="http://sniperman.free.fr/cs_Qweb_Corr.php">Voir Correction d&eacute;taill&eacute;e :</a></li>
</ul>
<p align="center">&nbsp;</p>
<p align="center">&nbsp;
