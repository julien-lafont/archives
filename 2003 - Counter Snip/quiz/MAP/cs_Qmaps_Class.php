...
# Dernier ID
$req="SELECT * FROM quiz2 WHERE quiz='map' ORDER BY date DESC LIMIT 1"  or die ('erreur 111');
$result=mysql_query($req); 
$dernier=mysql_fetch_array($result); 

# Tous
$req = mysql_query("SELECT * FROM quiz2 WHERE quiz='map' order by note DESC");
    ...
    <TD WIDTH=579 BGCOLOR=#364132 VALIGN=top ALIGN=center> 
        <TABLE CELLPADDING=0 CELLSPACING=0 BORDER=0 WIDTH=575>
  		<TR>
    		...
    		<TD BACKGROUND=images/cad_bleue_h.gif WIDTH=523 CLASS=menu><b>Quizz / MAPS
    		    / Classement :</b></TD>
