...
# Dernier ID
$req="SELECT * FROM quiz2 ORDER BY date DESC LIMIT 1" or die ('erreur 111');
$result=mysql_query($req); 
$dernier=mysql_fetch_array($result); 

# Tous
$req = mysql_query("SELECT * FROM quiz2 order by note DESC");
    ...
    <TD WIDTH=579 BGCOLOR=#364132 VALIGN=top ALIGN=center> 
        <TABLE CELLPADDING=0 CELLSPACING=0 BORDER=0 WIDTH=575>
  		<TR>
    		...
    		<TD BACKGROUND=images/cad_bleue_h.gif WIDTH=523 CLASS=menu><b>Quizz / Armes
    		    / Classement :</b></TD>
  		...
  		<TR>
    		...
    		<TD BGCOLOR=#4D574A WIDTH=523> <p>Voici la page de classement du Quizz
    		    : ARMES :</p>
    		  <blockquote>
    		    <p><img src="images/Puces/puceverte.gif" width="10" height="10"> Nb
   		      Total de Quiz  :                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        <strong><? print "$total"; ?> </strong>   		      
    		    <p><img src="images/Puces/puceverte.gif" width="10" height="10"> Nb
   		      Total de Quiz ARME : <strong><? print "$Nbarme"; ?>    		    </strong>
    		    <p><img src="images/Puces/puceverte.gif" width="10" height="10"> Meilleur
   		      Quiz ARME : <strong><? print "$meilleur[pseudo] avec $meilleur[note]/10
"; ?> </strong>   		      
    		    <p><img src="images/Puces/puceverte.gif" width="10" height="10"> Dernier
                Quiz ARME : <strong><? print "$dernier[pseudo] avec $dernier[note]/10
"; ?> </strong>                
    		    <p><img src="images/Puces/puceverte.gif" width="10" height="10"> Classement
              G&eacute;n&eacute;ral quiz ARME :                 
                <p><font color="#000000">
<?
