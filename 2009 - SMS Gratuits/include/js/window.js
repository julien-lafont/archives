	function yotsumi() {
		win = new Window('dialog', {className: "alphacube", title: "Infos sur YoTsumi", width:300, height:200, maximizable:false,  resizable: true, showEffectOptions: {duration:1}})
	...
	function xhtml() { 
		var win2 = new Window('xhtml', {className: "alphacube", title: "Validation Xhtml", width:700, height:400, resizable: true, url: "http://validator.w3.org/check?uri=referer", showEffectOptions: {duration:1}}) 
		win2.showCenter();
	}

	function css() { 
		var win3 = new Window('css', {className: "alphacube", title: "Validation CSS", width:700, height:400, resizable: true, url: "http://jigsaw.w3.org/css-validator/check/referer", showEffectOptions: {duration:1}}) 
		win3.showCenter();
	}
