...
function ajouterNum3(r) {
	...
	if (unescape(r)=="ok") {
		...
		parent.Windows.close("addnum");
		win9 = new parent.Window('erreur1', {className: "alphacube", title: "", width:200, height:80, maximizable:false, minimizable:false, resizable: true, showEffectOptions: {duration:1}})
...
function messFraude(nb) {
	win7 = new Window('erreur', {className: "alphacube", title: "Fraude détectée", width:300, height:200, maximizable:false,  resizable: true, showEffectOptions: {duration:1}})
...
function sendSms() { 
	...
	if (num0.length!=10 || mess0.length>161) {
		win4 = new Window('erreur', {className: "alphacube", title: "Erreur !", width:300, height:200, maximizable:false,  resizable: true, showEffectOptions: {duration:1}})
		win4.getContent().innerHTML= "<div style='padding:10px;'> <b>Une erreur a été détectée.</b><br><br>Nous vous rapellons que tout les champs doivent être remplis correctement : <br><br><div style='margin-left:10px; font-size:11px'>- Numéro de téléphone Français à 10 chiffres<br>- Message de 160 caractères maximum<br></div></div>";
		win4.showCenter();
	} else {
...
function sendSmsDemo() {  
	...
	if (num0.length!=10 || mess0.length>161) {
		win4 = new Window('erreur', {className: "alphacube", title: "Erreur !", width:300, height:200, maximizable:false,  resizable: true, showEffectOptions: {duration:1.5}})
		win4.getContent().innerHTML= "<div style='padding:10px;'> <b>Une erreur a été détectée.</b><br><br>Nous vous rapellons que tout les champs doivent être remplis correctement : <br><br><div style='margin-left:10px; font-size:11px'>- Numéro de téléphone Français à 10 chiffres<br>- Message de 160 caractères maximum<br></div></div>";
		win4.showCenter();
	} else {
		Element.hide('envoyer');
...
function demoQuotat() {
	win7 = new Window('erreur', {className: "alphacube", title: "Erreur quotat", width:300, height:200, maximizable:false,  resizable: true, showEffectOptions: {duration:1.5}})
...
function sendSms2(r) {
	if (unescape(r)=="ok") {
		...
		win5 = new Window('erreur', {className: "alphacube", title: "Erreur !", width:250, height:150, maximizable:false,  resizable: false, showEffectOptions: {duration:1.5}})
