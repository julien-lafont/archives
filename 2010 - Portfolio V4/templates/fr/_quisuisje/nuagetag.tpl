<img src="images/T_NuageTag.png" alt="Qui suis-je ?" /><br /><br />
	...
	<div class="center">
		...
		<param name="flashvars" value="tcolor=0xffffff&amp;tagcloud={$tags}" />
...
<table class="suiv_prec">
	<tr>
		...
		{*<td style="width:50%; text-align:right"> &rsaquo; Page suivante : <a href="#6" class="cross-link">Retour d'exp sur le portfolio</a> &rsaquo;</td>*}
