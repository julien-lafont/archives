<?php /* Smarty version 2.6.18, created on 2008-02-06 13:45:51
         compiled from bloc_login.tpl */ ?>
...
<?php else: ?>
	...
	<?php if (est_admin): ?><img src="templates/images/admin_icone.png" alt="MC" /> &nbsp;<a href="admin.php">Admin</a><br /><?php endif; ?>
    </div>
 <?php endif; ?>